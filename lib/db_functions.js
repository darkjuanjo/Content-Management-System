...
function removeEmployee() {
    ...
    .then(employees => {
        ...
        .then(selected_employee => {
            db.removeEmployee(selected_employee.delete_employee);
...
function updateInfo(type) {
    if(type === 'role')
    {
        ...
        .then(rows => {
            ...
            .prompt([
                {
                    ...
                    message: 'Choose employee to update? (Required)',
                    choices: employees,
                    validate: update_employee_roleInput => {
                        if(update_employee_roleInput){
                            return  true;
                        } else {
                            console.log('Please choose an employee to update!');
                            return false;
                        }
                    }
                },
            ...
            .then(selected_employee => {
                db.updateEmployeeRole(selected_employee.update_employee_info, selected_employee.new_role);
        ...
        .then(rows => {
            ...
            .prompt([
                ...
                },
                {
                    type: 'list',
                    name: 'new_manager',
                    message: 'Choose new manager? (Required)',
                    choices: employees,
                    validate: new_managerInput => {
                        if(new_managerInput){
                            return  true;
                        } else {
                            console.log('Please choose new manager!');
                            return false;
                        }
                    }
                },
            ...
            .then(selected_employee => {
                db.updateEmployeeManager(selected_employee.update_employee_info, selected_employee.new_manager);
