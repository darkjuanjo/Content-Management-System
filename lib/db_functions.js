...
function updateRole() {
    ...
    .then(rows => {
        ...
        .prompt([
            {
                ...
                message: 'Choose employee to update role? (Required)',
                choices: employees,
                validate: update_employee_roleInput => {
                    if(update_employee_roleInput){
                        return  true;
                    } else {
                        console.log('Please choose an employee to update role!');
                        return false;
                    }
                }
            },
        ...
        .then(selected_employee => {
            db.updateEmployeeRole(selected_employee.update_employee_role, selected_employee.new_role);
